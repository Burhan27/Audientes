package com.audientes.android.professional.device.sim;
...
public class SimWaveDevice extends SimBLEDevice
{
    ...
    private void postTrace(int id, int p0, int p1, int p2)
    {
        ...
        int16bytes(id, data, 0);
        int32bytes(getTX(), data, 2);
        int16bytes(p0, data, 6);
        int16bytes(p1, data, 8);
        int16bytes(p2, data, 10);
