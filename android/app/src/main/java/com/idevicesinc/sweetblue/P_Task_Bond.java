...
final class P_Task_Bond extends PA_Task_RequiresBleOn
{
    ...
    public P_Task_Bond(BleDevice device, boolean explicit, boolean direct, boolean partOfConnection, PA_Task.I_StateListener listener, PE_TaskPriority priority, E_TransactionLockBehavior lockBehavior)
    {
    ...
    public P_Task_Bond(BleDevice device, boolean explicit, boolean direct, boolean partOfConnection, PA_Task.I_StateListener listener, E_TransactionLockBehavior lockBehavior)
    {
    ...
    @Override
    public final boolean isMoreImportantThan(PA_Task task)
    {
    ...
    @Override
    protected final boolean isSoftlyCancellableBy(PA_Task task)
    {
