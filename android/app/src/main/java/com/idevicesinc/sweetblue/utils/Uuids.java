...
public final class Uuids
{
	...
	public enum GATTDisplayType
	{
		...
		public java.lang.String toString(byte data[])
		{
			switch (this)
			{
				case Boolean:
					java.lang.Boolean b = new Boolean(Utils_Byte.byteToBool(data[0]));
					return b.toString();
				case Bitfield:
				...
				case String:
					try
					{
						java.lang.String s = new String(data, "UTF-8");
						return s;
					}
					catch (Exception e)
					{
		...
		public Object stringToObject(java.lang.String s)
		{
			switch (this)
			{
				case Boolean:
