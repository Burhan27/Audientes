...
abstract class PA_Task_ConnectOrDisconnectServer extends PA_Task_RequiresBleOn
{
	...
	PA_Task_ConnectOrDisconnectServer(final BleServer server, final BluetoothDevice device, final PA_Task.I_StateListener listener, final boolean explicit, final PE_TaskPriority priority)
	{
