...
public final class BleServer extends BleNode
{
	...
	public static interface ExchangeListener
	{
		...
		public abstract static class ExchangeEvent extends Event
		{
            ...
            UUID charUuid() {  return m_charUuid; }
			 ...
			 */
			public final @Nullable(Nullable.Prevalence.NEVER)
            UUID descUuid() {  return m_descUuid; }
...
//					"server",			server().getName_debug(),
	...
	public static class DefaultConnectionFailListener implements ConnectionFailListener
	{
		...
		@Override
        public final Please onEvent(ConnectionFailEvent e)
		{
	...
	@Advanced
	public final @Nullable(Nullable.Prevalence.RARE)
    P_NativeServerLayer getNativeLayer()
	{
	...
	/*package*/ final ConnectionFailListener.ConnectionFailEvent connect_internal(final BluetoothDevice nativeDevice, final StateListener stateListener, final ConnectionFailListener connectionFailListener)
	{
		...
		m_stateTracker.doStateTransition(nativeDevice.getAddress(), BleServerState.DISCONNECTED /* ==> */, BleServerState.CONNECTING, State.ChangeIntent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE);
	...
	public final boolean disconnect(final String macAddress)
	{
		...
		return disconnect_private(macAddress_normalized, ConnectionFailListener.Status.CANCELLED_FROM_DISCONNECT, State.ChangeIntent.INTENTIONAL);
	}

	private boolean disconnect_private(final String macAddress, final ConnectionFailListener.Status status_connectionFail, final State.ChangeIntent intent)
	{
	...
	/*package*/ final void disconnect_internal(final ServiceAddListener.Status status_serviceAdd, final ConnectionFailListener.Status status_connectionFail, final State.ChangeIntent intent)
	{
		stopAdvertising();
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NORMAL)
    BluetoothGattService removeService(final UUID serviceUuid)
	{
