...
public final class HistoricalData implements UsesCustomNull
{
	...
	public static @Nullable(Nullable.Prevalence.NEVER)
    HistoricalData denull(@Nullable(Nullable.Prevalence.NORMAL) final HistoricalData historicalData_nullable)
	{
	...
	public static @Nullable(Nullable.Prevalence.NEVER)
    HistoricalData fromCursor(final Cursor cursor)
	{
		if( cursor == null )
		{
