...
final class P_Task_Scan extends PA_Task_RequiresBleOn
{
    ...
    public P_Task_Scan(BleManager manager, PA_Task.I_StateListener listener, double scanTime, boolean periodicScan, PE_TaskPriority priority)
    {
...
//				return getTimeout() == TIMEOUT_INFINITE && this.getTotalTimeExecuting() >= getManager().m_config.minimumScanTime;
    ...
    @Override
    public boolean isInterruptableBy(PA_Task otherTask)
    {
