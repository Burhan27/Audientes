...
//		m_serverMngr = new P_ServerManager(this);
	...
	public final void setListener_State(@Nullable(Prevalence.NORMAL) final StateListener listener_nullable)
	{
		...
		else
		{
			...
			{
				@Override
                public void onEvent(StateListener.StateEvent e)
				{
					if (listener_nullable != null)
					{
...
//				scanTask.succeed();
    ...
    BleDevice getDevice(final String macAddress)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    BleDevice getDevice(BleDeviceState state)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    BleDevice getDevice(Object... query)
	{
		for( int i = 0; i < m_deviceMngr.getCount(); i++ )
		{
			BleDevice device = m_deviceMngr.get(i);
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    BleDevice getDevice(final int mask_BleDeviceState)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    BleDeviceIterator getDevices_sorted()
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    List<BleDevice> getDevices_List_sorted()
	{
	...
	@Deprecated
	public final @Nullable(Prevalence.NEVER)
    BleDevice getDeviceAt(final int index)
	{
	...
	@Deprecated
	public final @Nullable(Prevalence.NEVER)
    BleDevice getDevice_previous(final BleDevice device)
	{
	...
	@Deprecated
	public final @Nullable(Prevalence.NEVER)
    BleDevice getDevice_next(final BleDevice device)
	{
		return m_deviceMngr.getDevice_offset(device, 1);
	}
	...
	@Deprecated
	public final @Nullable(Prevalence.NEVER)
    BleDevice getDevice_previous(final BleDevice device, final BleDeviceState state)
	{
	...
	@Deprecated
	public final @Nullable(Prevalence.NEVER)
    BleDevice getDevice_next(final BleDevice device, final BleDeviceState state)
	{
		return m_deviceMngr.getDevice_offset(device, 1, state, true);
	}
	...
	@Deprecated
	public final @Nullable(Prevalence.NEVER)
    BleDevice getDevice_previous(final BleDevice device, final Object... query)
	{
	...
	@Deprecated
	public final @Nullable(Prevalence.NEVER)
    BleDevice getDevice_next(final BleDevice device, final Object... query)
	{
		return m_deviceMngr.getDevice_offset(device, 1, query);
	}
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    BleDeviceIterator getDevices(final BleDeviceState state)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    List<BleDevice> getDevices_List(final BleDeviceState state)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    List<BleDevice> getDevices_List_sorted(final BleDeviceState state)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    BleDeviceIterator getDevices(final Object... query)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    List<BleDevice> getDevices_List(final Object... query)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    List<BleDevice> getDevices_List_sorted(final Object... query)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    BleDeviceIterator getDevices(final int mask_BleDeviceState)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    List<BleDevice> getDevices_List(final int mask_BleDeviceState)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    List<BleDevice> getDevices_List_sorted(final int mask_BleDeviceState)
	{
...
//		bleServer.setConfig(config);
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    BleDevice newDevice(String macAddress)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    BleDevice newDevice(final String macAddress, final String name)
	{
	...
	public final @Nullable(Prevalence.NEVER)
    BleDevice newDevice(final String macAddress, final BleDeviceConfig config)
	{
	 ...
	 */
	public final @Nullable(Prevalence.NEVER)
    BleDevice newDevice(final String macAddress, final String name, final BleDeviceConfig config)
	{
		final String macAddress_normalized = normalizeMacAddress(macAddress);
