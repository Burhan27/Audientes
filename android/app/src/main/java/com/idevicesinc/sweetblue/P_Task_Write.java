...
final class P_Task_Write extends PA_Task_ReadOrWrite
{
	...
	@Override
    protected ReadWriteEvent newReadWriteEvent(final Status status, final int gattStatus, final Target target, final UUID serviceUuid, final UUID charUuid, final UUID descUuid)
	{
	...
	@Override
    public void onStateChange(final PA_Task task, final PE_TaskState state)
	{
