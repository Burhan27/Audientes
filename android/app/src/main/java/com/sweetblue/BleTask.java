...
public enum BleTask
{
	...
	/**
	 * Associated with {@link BleDevice#read(java.util.UUID, BleDevice.ReadWriteListener)}.
	 */
	READ,
	
	/**
	 * Associated with {@link BleDevice#write(java.util.UUID, byte[], BleDevice.ReadWriteListener)}.
	 */
	WRITE,
	
	/**
	 * Associated with {@link BleDevice#enableNotify(java.util.UUID, BleDevice.ReadWriteListener)} and
	 * {@link BleDevice#disableNotify(java.util.UUID, BleDevice.ReadWriteListener)}.
	 */
	TOGGLE_NOTIFY,
	
	/**
	 * Associated with {@link BleDevice#readRssi()} and {@link BleDevice#startRssiPoll(Interval)} (and overloads thereof).
	 */
	READ_RSSI,
