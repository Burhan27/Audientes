 ...
 * method you then do some reads/writes and call {@link #succeed()} or {@link #fail()} depending on the {@link BleDevice.ReadWriteListener.Status} returned.
 * <br><br>
...
//				m_device.getManager().getLogger().w("Transaction is already ended!");
	 ...
	 * {@link ReadWriteListener#onEvent(Event)} when {@link BleDevice.ReadWriteListener.Status} is something other than {@link BleDevice.ReadWriteListener.Status#SUCCESS}. If you do so,
