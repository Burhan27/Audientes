...
import com.sweetblue.BleManager.DiscoveryListener;
...
import com.sweetblue.utils.Pointer;
import com.sweetblue.utils.ReflectionUuidNameMap;
...
import com.sweetblue.utils.UuidNameMap;
...
public class BleManagerConfig extends BleDeviceConfig
{
	 ...
	 * {@link BleManager}, SweetBlue will still respect the {@link #uhOhCallbackThrottle}. Otherwise, if you restart the manager, and get an {@link BleManager.UhOhListener.UhOh}
...
//	public PI_UpdateLoop.IUpdateLoopFactory updateLoopFactory	= new PI_UpdateLoop.DefaultUpdateLoopFactory();
	...
	/**
	 * Default is {@link BleManagerConfig.DeviceNameComparator}. This specifies how to
