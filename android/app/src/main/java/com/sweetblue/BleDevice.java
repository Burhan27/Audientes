...
import com.sweetblue.BleDevice.BondListener.BondEvent;
import com.sweetblue.BleDevice.ConnectionFailListener.ConnectionFailEvent;
import com.sweetblue.BleDevice.ConnectionFailListener.Status;
import com.sweetblue.BleDevice.ConnectionFailListener.Timing;
import com.sweetblue.BleDevice.ReadWriteListener.ReadWriteEvent;
import com.sweetblue.BleDevice.ReadWriteListener.Type;
import com.sweetblue.BleDeviceConfig.BondFilter;
import com.sweetblue.BleDeviceConfig.BondFilter.CharacteristicEventType;
import com.sweetblue.BleNode.ConnectionFailListener.AutoConnectUsage;
import com.sweetblue.PA_StateTracker.E_Intent;
import com.sweetblue.P_Task_Bond.E_TransactionLockBehavior;
...
import com.sweetblue.annotations.Nullable.Prevalence;
import com.sweetblue.utils.BleScanInfo;
import com.sweetblue.utils.Distance;
import com.sweetblue.utils.EmptyIterator;
import com.sweetblue.utils.EpochTime;
import com.sweetblue.utils.EpochTimeRange;
import com.sweetblue.utils.Event;
import com.sweetblue.utils.ForEach_Breakable;
import com.sweetblue.utils.ForEach_Returning;
...
import com.sweetblue.utils.HistoricalDataCursor;
...
import com.sweetblue.utils.State.ChangeIntent;
import com.sweetblue.utils.TimeEstimator;
import com.sweetblue.utils.UsesCustomNull;
import com.sweetblue.utils.Utils;
import com.sweetblue.utils.Utils_Byte;
import com.sweetblue.utils.Utils_Rssi;
import com.sweetblue.utils.Utils_ScanRecord;
import com.sweetblue.utils.Utils_State;
import com.sweetblue.utils.Utils_String;
import com.sweetblue.utils.Uuids;
...
import static com.sweetblue.BleDeviceState.ADVERTISING;
import static com.sweetblue.BleDeviceState.AUTHENTICATED;
import static com.sweetblue.BleDeviceState.AUTHENTICATING;
import static com.sweetblue.BleDeviceState.BONDED;
import static com.sweetblue.BleDeviceState.BONDING;
import static com.sweetblue.BleDeviceState.CONNECTED;
import static com.sweetblue.BleDeviceState.CONNECTING;
import static com.sweetblue.BleDeviceState.CONNECTING_OVERALL;
import static com.sweetblue.BleDeviceState.DISCONNECTED;
import static com.sweetblue.BleDeviceState.DISCOVERED;
import static com.sweetblue.BleDeviceState.DISCOVERING_SERVICES;
import static com.sweetblue.BleDeviceState.INITIALIZED;
import static com.sweetblue.BleDeviceState.INITIALIZING;
import static com.sweetblue.BleDeviceState.PERFORMING_OTA;
import static com.sweetblue.BleDeviceState.RECONNECTING_LONG_TERM;
import static com.sweetblue.BleDeviceState.RECONNECTING_SHORT_TERM;
import static com.sweetblue.BleDeviceState.RETRYING_BLE_CONNECTION;
import static com.sweetblue.BleDeviceState.SERVICES_DISCOVERED;
import static com.sweetblue.BleDeviceState.UNBONDED;
import static com.sweetblue.BleDeviceState.UNDISCOVERED;
...
public final class BleDevice extends BleNode
{
     ...
     *
     * @deprecated - Refactored to {@link com.sweetblue.ReadWriteListener}. This class will stay until version 3.0, when it will
     * be removed.
     */
    @Lambda
    public static interface ReadWriteListener extends GenericListener_Void<ReadWriteListener.ReadWriteEvent>
    {
        /**
        ...
        public static class ReadWriteEvent extends Event implements UsesCustomNull
        {
             ...
             * Another theoretical case is if you make an explicit call through SweetBlue, then you get {@link BleDevice.ReadWriteListener.Status#TIMED_OUT},
...
//			}
     ...
     */
    @Lambda
    public static interface BondListener extends GenericListener_Void<BondListener.BondEvent>
    {
        /**
    ...
    private com.sweetblue.ReadWriteListener m_defaultReadWriteListener = null;
     ...
     *
     * @deprecated - This will be removed in version 3. Use {@link com.sweetblue.ReadWriteListener} instead (it was refactored to be in it's own class file, rather than an inner class).
     */
    public final void setListener_ReadWrite(@Nullable(Prevalence.NORMAL) final ReadWriteListener listener_nullable)
    {
        ...
        {
            m_defaultReadWriteListener = new com.sweetblue.ReadWriteListener()
            {
     ...
     * NOTE: This will be called after the {@link ReadWriteListener} provided directly through the method params.
     */
    public final void setListener_ReadWrite(@Nullable(Prevalence.NORMAL) com.sweetblue.ReadWriteListener listener_nullable)
    {
        if (isNull()) return;
     ...
     * be called when toggling notifications. This does NOT replace {@link com.sweetblue.ReadWriteListener}, just adds to it. If
     * a default {@link com.sweetblue.ReadWriteListener} has been set, it will still fire in addition to this listener.
     */
     ...
     *
     * @deprecated - Use {@link #write(com.sweetblue.WriteBuilder)} instead. This will be removed in v3.0
     */
    @Deprecated
    public final @Nullable(Prevalence.NEVER) ReadWriteListener.ReadWriteEvent write(WriteBuilder writeBuilder)
    {
        return write(com.sweetblue.WriteBuilder.fromDeprecatedWriteBuilder(writeBuilder));
    }
     ...
     * @deprecated - Use {@link #write(com.sweetblue.WriteBuilder, ReadWriteListener)} instead. This will be removed in v3.0
     */
    @Deprecated
    ...
    {
        return write(com.sweetblue.WriteBuilder.fromDeprecatedWriteBuilder(writeBuilder), listener);
    }
     ...
     * @see #write(UUID, UUID, byte[])
     */
    public final @Nullable(Prevalence.NEVER) ReadWriteListener.ReadWriteEvent write(com.sweetblue.WriteBuilder writeBuilder)
    {
     ...
     * @see #write(UUID, UUID, byte[], ReadWriteListener)
     */
    public final @Nullable(Prevalence.NEVER) ReadWriteListener.ReadWriteEvent write(com.sweetblue.WriteBuilder writeBuilder, ReadWriteListener listener)
    {
    ...
    {
        final com.sweetblue.WriteBuilder write = new com.sweetblue.WriteBuilder(serviceUuid, characteristicUuid)
    ...
    {
        final com.sweetblue.WriteBuilder builder = new com.sweetblue.WriteBuilder(serviceUuid, characteristicUuid)
     ...
     * to either {@link BleDevice#setListener_ReadWrite(ReadWriteListener)} or {@link BleManager#setListener_ReadWrite(BleDevice.ReadWriteListener)}.
     *
...
//                    retrying__PE_Please = ConnectionFailListener.Please.PE_Please_DO_NOT_RETRY;PE_Please_DO_NOT_RETRY
    ...
    final ReadWriteListener.ReadWriteEvent write_internal(final com.sweetblue.WriteBuilder wb)
    {
     ...
     *
     * @deprecated - Use {@link com.sweetblue.WriteBuilder} instead. This will be removed in v 3.0
     */
    @Deprecated
    public static class WriteBuilder
    {
        ...
        /**
         * Overload of {@link BleDevice.WriteBuilder#BleDevice.WriteBuilder(boolean, UUID, UUID)}. If @param isBigEndian is true,
         *
        ...
        /**
         * Overload of {@link BleDevice.WriteBuilder#BleDevice.WriteBuilder(boolean, UUID, UUID)}.
         */
        ...
        /**
         * Overload of {@link BleDevice.WriteBuilder#BleDevice.WriteBuilder(boolean, UUID, UUID, DescriptorFilter)}.
         */
