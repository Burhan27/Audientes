...
public final class BleWriteTransaction extends BleTransaction.Ota
{
     ...
     * proceed on error.
     *
     * @see BleWriteTransaction.FailListener.Please
     */
    ...
    /**
     * Instantiate a new {@link BleWriteTransaction} with a {@link BleWriteTransaction.WriteQueueListener}, which
     * allows you to perform operations between each write in the queue, and a {@link BleWriteTransaction.FailListener} to
