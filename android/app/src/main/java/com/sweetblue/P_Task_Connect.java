...
final class P_Task_Connect extends PA_Task_RequiresBleOn
{
	...
	private BleNode.ConnectionFailListener.AutoConnectUsage m_autoConnectUsage = BleNode.ConnectionFailListener.AutoConnectUsage.UNKNOWN;
	...
	@Override public void execute()
	{
		...
		if( m_explicit )
		{
			...
			m_autoConnectUsage = useAutoConnect ? BleNode.ConnectionFailListener.AutoConnectUsage.USED : BleNode.ConnectionFailListener.AutoConnectUsage.NOT_USED;
...
//			this.fail();
	...
	public BleNode.ConnectionFailListener.AutoConnectUsage getAutoConnectUsage()
	{
