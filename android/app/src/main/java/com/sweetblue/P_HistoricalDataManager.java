...
import com.sweetblue.backend.historical.Backend_HistoricalDataList;
...
import com.sweetblue.utils.UpdateLoop;
...
final class P_HistoricalDataManager
{
	...
	//GOOD
	public void add_single(final UUID uuid, final HistoricalData historicalData, final BleNodeConfig.HistoricalDataLogFilter.Source source)
	{
		final Backend_HistoricalDataList list = getList_createIfNotExists(uuid);

		final BleNodeConfig.HistoricalDataLogFilter.Please please = PU_HistoricalData.getPlease(m_endPoint, m_macAddress, uuid, historicalData.getBlob(), historicalData.getEpochTime(), source);
	...
	public void add_multiple(final UUID uuid, final Iterator<HistoricalData> historicalData)
	{
		...
		final BleNodeConfig.HistoricalDataLogFilter.Please please = PU_HistoricalData.getPlease(m_endPoint, m_macAddress, uuid, P_Const.EMPTY_BYTE_ARRAY, EpochTime.NULL, BleNodeConfig.HistoricalDataLogFilter.Source.MULTIPLE_MANUAL_ADDITIONS);
