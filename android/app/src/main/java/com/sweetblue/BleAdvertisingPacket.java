...
/**
 * Class to used for advertising Bluetooth services, used with {@link BleServer#startAdvertising(BleAdvertisingPacket)}
 */
public final class BleAdvertisingPacket {
    ...
    /*package*/ AdvertiseSettings getNativeSettings(BleAdvertisingSettings.BleAdvertisingMode mode, BleAdvertisingSettings.BleTransmissionPower power, Interval timeout) {
