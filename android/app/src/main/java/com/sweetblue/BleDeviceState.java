...
import com.sweetblue.utils.BitwiseEnum;
 ...
 * Use {@link BleDevice#setListener_State(BleDevice.StateListener)} to be notified of state changes.
 * 
...
public enum BleDeviceState implements State
{
	...
	/**
	 * The device has been undiscovered and you should have been notified through {@link BleManager.DiscoveryListener#onEvent(BleManager.DiscoveryListener.DiscoveryEvent)}.
	 ...
	 * is not active. Note that this doesn't *necessarily* mean that the actual physical device is advertising, just that it was {@link BleManager.DiscoveryListener.LifeCycle#DISCOVERED}
	 * or {@link BleManager.DiscoveryListener.LifeCycle#REDISCOVERED} through a {@link BleManager#startScan()}, so it is still assumed to be advertising.
	 */
	ADVERTISING,
