...
public final class Utils_ScanRecord extends Utils
{
	...
	{
		final com.sweetblue.utils.ByteBuffer buff = new com.sweetblue.utils.ByteBuffer();
		if (advFlags != null)
		{
			buff.append((byte) 2);
	...
	public static byte[] getUuidBytes(UUID id, BleUuid.UuidSize size)
	{
		...
		switch (size)
		{
			...
			default /*FULL*/:
				...
				com.sweetblue.utils.ByteBuffer buff = new com.sweetblue.utils.ByteBuffer(size.byteSize());
