...
import com.sweetblue.BleManagerState;
import com.sweetblue.P_StringHandler;
...
public final class BluetoothEnabler
{
	...
	/**
	 * Overload of {@link #start(Activity, BluetoothEnablerFilter)} that uses an instance of {@link BluetoothEnabler.DefaultBluetoothEnablerFilter}.
	 */
    ...
    public static interface BluetoothEnablerFilter
    {
        ...
        public static class BluetoothEnablerEvent extends Event
        {
			 ...
			 *
			 * @see BluetoothEnabler.BluetoothEnablerFilter.Please#withAppData(Object)
			 */
        ...
        public static class Please
        {
            ...
            /**
             * Pause the enabler. Call {@link BluetoothEnabler#resume(BluetoothEnablerFilter.Please)} to continue the process.
             */
			...
			/**
			 * Add arbitrary app-specific data which will be passed to the next {@link BluetoothEnabler.BluetoothEnablerFilter.BluetoothEnablerEvent}
			 * through
			 */
