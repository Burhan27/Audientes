...
/**
 * Class representing a range of time between two instances of {@link EpochTime}.
...
{
	/**
	 * Fulfills the soft contract of {@link UsesCustomNull} - used for {@link #isNull()}.
	 */
	 ...
	 * or {@link EpochTime#NULL} if <code>null</code>
