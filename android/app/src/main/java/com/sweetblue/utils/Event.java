...
public abstract class Event
{
	 ...
	 * For example for {@link BleDevice.ReadWriteListener.ReadWriteEvent} you could write
	 ...
	 * with the input strings against {@link BleDevice.ReadWriteListener.ReadWriteEvent#macAddress()}.
	 */
	 ...
	 * This method would then just do a comparison with the input values against {@link BleDevice.ReadWriteListener.ReadWriteEvent#macAddress()},
	 * {@link BleDevice.ReadWriteListener.ReadWriteEvent#charUuid()} {@link BleDevice.ReadWriteListener.ReadWriteEvent#descUuid()}, and
	 * {@link BleDevice.ReadWriteListener.ReadWriteEvent#serviceUuid()}.
	 */
