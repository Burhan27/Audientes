...
public final class WriteBuilder
{
    ...
    /**
     * Set the {@link BleDevice.ReadWriteListener.Type} of the write to perform. This is here in the case that the
    ...
    /**
     * Set the {@link BleDevice.ReadWriteListener} for listening to the callback of the write.
     *
