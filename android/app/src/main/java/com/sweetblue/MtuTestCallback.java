...
public interface MtuTestCallback
{
    ...
    class TestResult
    {
         ...
         * the {@link BleDevice.ReadWriteListener.Status} from the write which was performed as the test.
         */
    ...
    class Please
    {
        ...
        /**
         * Tell SweetBlue what characteristic it should write to, and provide the data to write. The byte array size should ideally be the size of the newly
         * negotiated MTU size. This also allows you to set the write type -- one of {@link BleDevice.ReadWriteListener.Type#WRITE} (this is the default),
         * {@link BleDevice.ReadWriteListener.Type#WRITE_NO_RESPONSE}, or {@link BleDevice.ReadWriteListener.Type#WRITE_SIGNED}.
         */
