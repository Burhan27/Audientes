...
import com.sweetblue.compat.K_Util;
...
//				at P_NativeDeviceWrapper.closeGatt(P_NativeDeviceWrapper.java:319)
//				at P_NativeDeviceWrapper.closeGattIfNeeded(P_NativeDeviceWrapper.java:301)
//				at BleDevice.onNativeConnectFail(BleDevice.java:5782)
//				at P_BleDevice_Listeners$1.onStateChange(P_BleDevice_Listeners.java:51)
//				at PA_Task.setState(PA_Task.java:148)
//				at PA_Task.setEndingState(PA_Task.java:288)
//				at P_TaskQueue.endCurrentTask(P_TaskQueue.java:288)
//				at P_TaskQueue.tryEndingTask_mainThread(P_TaskQueue.java:395)
//				at P_TaskQueue.tryEndingTask(P_TaskQueue.java:387)
//				at PA_Task.timeout(PA_Task.java:183)
//				at PA_Task.update_internal(PA_Task.java:354)
//				at P_TaskQueue.update(P_TaskQueue.java:236)
//				at BleManager.update(BleManager.java:3245)
//				at BleManager$1.onUpdate(BleManager.java:746)
//				at UpdateLoop$1.run(UpdateLoop.java:24)
...
//				P_NativeDeviceWrapper.closeGatt(P_NativeDeviceWrapper.java:238)
//				P_NativeDeviceWrapper.closeGattIfNeeded(P_NativeDeviceWrapper.java:221)
//				BleDevice.onNativeConnectFail(BleDevice.java:2193)
//				P_BleDevice_Listeners$1.onStateChange_synchronized(P_BleDevice_Listeners.java:78)
//				P_BleDevice_Listeners$1.onStateChange(P_BleDevice_Listeners.java:49)
//				PA_Task.setState(PA_Task.java:118)
//				PA_Task.setEndingState(PA_Task.java:242)
//				P_TaskQueue.endCurrentTask(P_TaskQueue.java:220)
//				P_TaskQueue.tryEndingTask(P_TaskQueue.java:267)
//				P_TaskQueue.fail(P_TaskQueue.java:260)
//				P_BleDevice_Listeners.onConnectionStateChange_synchronized(P_BleDevice_Listeners.java:168)
