...
import com.sweetblue.BleManager.DiscoveryListener.DiscoveryEvent;
import com.sweetblue.BleManager.DiscoveryListener.LifeCycle;
import com.sweetblue.BleManager.ResetListener.ResetEvent;
import com.sweetblue.BleManager.UhOhListener.UhOh;
import com.sweetblue.annotations.Advanced;
import com.sweetblue.annotations.Experimental;
import com.sweetblue.annotations.Nullable;
import com.sweetblue.annotations.Immutable;
import com.sweetblue.backend.historical.Backend_HistoricalDatabase;
import com.sweetblue.compat.M_Util;
import com.sweetblue.utils.EpochTime;
import com.sweetblue.utils.Event;
import com.sweetblue.utils.ForEach_Breakable;
import com.sweetblue.utils.ForEach_Void;
import com.sweetblue.utils.GattDatabase;
import com.sweetblue.utils.GenericListener_Void;
import com.sweetblue.utils.HistoricalData;
import com.sweetblue.utils.Interval;
import com.sweetblue.utils.Percent;
import com.sweetblue.utils.State;
import com.sweetblue.utils.Utils;
import com.sweetblue.utils.Utils_ScanRecord;
import com.sweetblue.utils.Utils_String;
import com.sweetblue.annotations.Lambda;
import com.sweetblue.utils.BluetoothEnabler;
...
public final class BleManager
{
	 ...
	 */
	@Lambda
	public static interface DiscoveryListener extends GenericListener_Void<DiscoveryListener.DiscoveryEvent>
	{
		/**
...
//    final P_ServerManager m_serverMngr;
	...
	private BleManager(Context context, BleManagerConfig config)
	{
		...
		m_stateTracker.append(nativeState, PA_StateTracker.E_Intent.UNINTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE);
		m_nativeStateTracker = new P_NativeBleStateTracker(this);
		m_nativeStateTracker.append(nativeState, PA_StateTracker.E_Intent.UNINTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE);
...
//		m_serverMngr = new P_ServerManager(this);
	 ...
	 */
	public final void setListener_HistoricalDataLoad(@Nullable(Nullable.Prevalence.NORMAL) final BleNode.HistoricalDataLoadListener listener_nullable)
	{
	 ...
	 */
	public final void setListener_State(@Nullable(Nullable.Prevalence.NORMAL) final StateListener listener_nullable)
	{
	 ...
	 */
	public final void setListener_DeviceState(@Nullable(Nullable.Prevalence.NORMAL) final BleDevice.StateListener listener_nullable)
	{
		if (listener_nullable == null)
		{
	 ...
	 */
	public final void setListener_ConnectionFail_Server(@Nullable(Nullable.Prevalence.NORMAL) BleServer.ConnectionFailListener listener_nullable)
	{
	 ...
	 *
	 * @see BleServer#setListener_Incoming(BleServer.IncomingListener)
	 */
	public final void setListener_Incoming(@Nullable(Nullable.Prevalence.NORMAL) BleServer.IncomingListener listener_nullable)
	{
	 ...
	 */
	public final void setListener_ServiceAdd(@Nullable(Nullable.Prevalence.NORMAL) BleServer.ServiceAddListener listener_nullable)
	{
	 ...
	 */
	public final void setListener_ServerState(@Nullable(Nullable.Prevalence.NORMAL) BleServer.StateListener listener_nullable)
	{
	 ...
	 */
	public final void setListener_Outgoing(@Nullable(Nullable.Prevalence.NORMAL) BleServer.OutgoingListener listener_nullable)
	{
	 ...
	 * {@link BleDevice#setListener_ConnectionFail(BleDevice.ConnectionFailListener)}. This is unlike the behavior
	 ...
	 */
	public final void setListener_ConnectionFail(@Nullable(Nullable.Prevalence.NORMAL) BleDevice.ConnectionFailListener listener_nullable)
	{
		m_defaultConnectionFailListener = listener_nullable;
	}

	/**
	 * Convenience method to set a default back up listener for all {@link BleDevice.BondListener.BondEvent}s across all {@link BleDevice} instances.
	 */
	public final void setListener_Bond(@Nullable(Nullable.Prevalence.NORMAL) BleDevice.BondListener listener_nullable)
	{
	 ...
	 */
	public final void setListener_ReadWrite(@Nullable(Nullable.Prevalence.NORMAL) final BleDevice.ReadWriteListener listener_nullable)
	{
		if (listener_nullable != null)
		{
	 ...
	 *
	 * @see BluetoothEnabler
	 */
	public final void startPeriodicScan(Interval scanActiveTime, Interval scanPauseTime)
	{
		startPeriodicScan(scanActiveTime, scanPauseTime, (BleManagerConfig.ScanFilter) null, (DiscoveryListener) null);
	}
	...
	{
		startPeriodicScan(scanActiveTime, scanPauseTime, (BleManagerConfig.ScanFilter) null, discoveryListener);
	}
	 ...
	 */
	public final void stopPeriodicScan(final BleManagerConfig.ScanFilter filter)
	{
	 ...
	 * @return <code>true</code> if scan started, <code>false></code> otherwise - usually this means this manager is not {@link BleManagerState#ON}.
	 */
	public final boolean startScan(BleManagerConfig.ScanFilter filter)
	{
	...
	{
		return startScan(Interval.INFINITE, (BleManagerConfig.ScanFilter) null, discoveryListener);
	}
	 ...
	 * @return <code>true</code> if scan started, <code>false></code> otherwise - usually this means this manager is not {@link BleManagerState#ON}.
	 */
	public final boolean startScan(Interval scanTime, BleManagerConfig.ScanFilter filter)
	{
	...
	{
		return startScan(scanTime, (BleManagerConfig.ScanFilter) null, discoveryListener);
	}
	 ...
	 * @return <code>true</code> if scan started, <code>false></code> otherwise - usually this means this manager is not {@link BleManagerState#ON}.
	 */
	public final boolean startScan(BleManagerConfig.ScanFilter filter, DiscoveryListener discoveryListener)
	{
	...
	{
		return startScan(scanTime, (BleManagerConfig.ScanFilter) null, (DiscoveryListener) null);
	}
	 ...
	 * through {@link BleManagerConfig.ScanFilter} you must have {@link android.Manifest.permission#ACCESS_COARSE_LOCATION} or {@link android.Manifest.permission#ACCESS_FINE_LOCATION}
	 ...
	 * @return <code>true</code> if scan started, <code>false></code> otherwise - usually this means this manager is not {@link BleManagerState#ON}.
	 */
	public final boolean startScan(Interval scanTime, BleManagerConfig.ScanFilter filter, DiscoveryListener discoveryListener)
	{
		showScanWarningIfNeeded();
...
//    {
	final boolean startScan_private(ScanOptions options)
	{
		...
		{
			m_logger.e(BleManager.class.getSimpleName() + " is not " + BleManagerState.ON + "! Please use the turnOn() method first.");
		...
		else
		{
			...
			m_stateTracker.append(BleManagerState.STARTING_SCAN, PA_StateTracker.E_Intent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE);
	...
	{
		if( isAny(BleManagerState.TURNING_ON, BleManagerState.ON) )  return;

		if( is(BleManagerState.OFF) )
		{
			m_stateTracker.update(PA_StateTracker.E_Intent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE, BleManagerState.TURNING_ON, true, BleManagerState.OFF, false);
		}
	...
	final void forceOn()
	{
		m_stateTracker.update(PA_StateTracker.E_Intent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE, BleManagerState.ON, true, BleManagerState.OFF, false);
	}

	final void forceOff()
	{
		m_stateTracker.update(PA_StateTracker.E_Intent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE, BleManagerState.ON, false, BleManagerState.OFF, true);
	}
	...
	{
		m_deviceMngr.unbondAll(null, BleDevice.BondListener.Status.CANCELLED_FROM_UNBOND);
	}
	...
	{
		if( isAny(BleManagerState.ON, BleManagerState.TURNING_ON) )  return;
	 ...
	 */
	public final void stopScan(BleManagerConfig.ScanFilter filter)
	{
		m_filterMngr.remove(filter);
	...
	final void stopScan_private(PA_StateTracker.E_Intent intent)
	{
		m_scanManager.resetTimeNotScanning();
...
//				scanTask.succeed();
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDevice(final String macAddress)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDevice(BleDeviceState state)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDevice()
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDevice(Object ... query)
	{
		for( int i = 0; i < m_deviceMngr.getCount(); i++ )
		{
			BleDevice device = m_deviceMngr.get(i);
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDeviceIterator getDevices()
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDeviceIterator getDevices_sorted()
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) List<BleDevice> getDevices_List()
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) List<BleDevice> getDevices_List_sorted()
	{
	 ...
	 */
	@Deprecated
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDeviceAt(final int index)
	{
	 ...
	 */
	@Deprecated
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDevice_previous(final BleDevice device)
	{
	 ...
	 */
	@Deprecated
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDevice_next(final BleDevice device)
	{
		return m_deviceMngr.getDevice_offset(device, 1);
	}
	 ...
	 */
	@Deprecated
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDevice_previous(final BleDevice device, final BleDeviceState state)
	{
	 ...
	 */
	@Deprecated
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDevice_next(final BleDevice device, final BleDeviceState state)
	{
		return m_deviceMngr.getDevice_offset(device, 1, state, true);
	}
	 ...
	 */
	@Deprecated
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDevice_previous(final BleDevice device, final Object ... query)
	{
	 ...
	 */
	@Deprecated
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice getDevice_next(final BleDevice device, final Object ... query)
	{
		return m_deviceMngr.getDevice_offset(device, 1, query);
	}
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDeviceIterator getDevices(final BleDeviceState state)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) List<BleDevice> getDevices_List(final BleDeviceState state)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) List<BleDevice> getDevices_List_sorted(final BleDeviceState state)
	{
	 ...
	 * See {@link BleDevice#is(Object...)} for the query format.
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDeviceIterator getDevices(final Object ... query)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) List<BleDevice> getDevices_List(final Object ... query)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) List<BleDevice> getDevices_List_sorted(final Object ... query)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDeviceIterator getDevices(final int mask_BleDeviceState)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) List<BleDevice> getDevices_List(final int mask_BleDeviceState)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) List<BleDevice> getDevices_List_sorted(final int mask_BleDeviceState)
	{
	...
	{
		return getServer((BleServer.IncomingListener) null);
	}

	/**
	 * Returns a {@link BleServer} instance. which for now at least is a singleton.
	 */
	public final BleServer getServer(final BleServer.IncomingListener incomingListener)
	{
...
//		bleServer.setConfig(config);
	...
	/**
	 * Overload of {@link #getServer(GattDatabase, BleServer.ServiceAddListener)}, with no {@link BleServer.ServiceAddListener} set.
	 */
	...
	/**
	 * Overload of {@link BleManager#getServer(BleServer.IncomingListener, GattDatabase, BleServer.ServiceAddListener)}, with no {@link BleServer.IncomingListener} set.
	 */
	 ...
	 */
	public final BleServer getServer(final BleServer.IncomingListener incomingListener, final GattDatabase gattDatabase, final BleServer.ServiceAddListener addServiceListener)
	{
		if (m_server == null)
		{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice newDevice(String macAddress)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice newDevice(final String macAddress, final String name)
	{
	...
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice newDevice(final String macAddress, final BleDeviceConfig config)
	{
	 ...
	 */
	public final @Nullable(Nullable.Prevalence.NEVER) BleDevice newDevice(final String macAddress, final String name, final BleDeviceConfig config)
	{
		final String macAddress_normalized = normalizeMacAddress(macAddress);
	...
	public final boolean undiscover(final BleDevice device)
	{
		...
		if( device.isAny(BleDeviceState.CONNECTED, BleDeviceState.CONNECTING, BleDeviceState.CONNECTING_OVERALL) )
			...
			m_deviceMngr.undiscoverAndRemove(device, m_discoveryListener, m_deviceMngr_cache, PA_StateTracker.E_Intent.INTENTIONAL);
	...
	{
		if( isAny(BleManagerState.TURNING_OFF, BleManagerState.OFF) )  return;

		if( is(BleManagerState.ON) )
		{
			m_stateTracker.update(PA_StateTracker.E_Intent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE, BleManagerState.TURNING_OFF, true, BleManagerState.ON, false);
		}
		...
		if( removeAllBonds )
		{
			m_deviceMngr.unbondAll(PE_TaskPriority.CRITICAL, BleDevice.BondListener.Status.CANCELLED_FROM_BLE_TURNING_OFF);
		}
		...
		final P_Task_TurnBleOff task = new P_Task_TurnBleOff(this, /*implicit=*/false, new PA_Task.I_StateListener()
		{
			@Override public void onStateChange(PA_Task taskClass, PE_TaskState state)
			{
				if( state == PE_TaskState.EXECUTING )
				{
					...
					{
						m_nativeStateTracker.append(BleManagerState.RESETTING, PA_StateTracker.E_Intent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE);
					}

					m_deviceMngr.undiscoverAllForTurnOff(m_deviceMngr_cache, PA_StateTracker.E_Intent.INTENTIONAL);
				}
			}
		});
	...
	final synchronized void onDiscoveredFromNativeStack(List<P_ScanManager.DiscoveryEntry> entries)
	{
		...
		if( false == is(BleManagerState.ON) )  return;
		...
		if( false == is(BleManagerState.SCANNING) )  return;
		...
		for (P_ScanManager.DiscoveryEntry entry : entries)
		{
			...
			final BleManagerConfig.ScanFilter.Please please;
			final boolean newlyDiscovered;
			final BleManagerConfig.ScanFilter.ScanEvent scanEvent_nullable;
			...
			if (device_sweetblue == null)
			{
				...
				scanEvent_nullable = m_filterMngr.makeEvent() ? BleManagerConfig.ScanFilter.ScanEvent.fromScanRecord(entry.device().getNativeDevice(), rawDeviceName, normalizedDeviceName, entry.rssi(), lastDisconnectIntent, entry.record()) : null;
	...
	private void reset_private(boolean nuclear, ResetListener listener)
	{
		...
		m_stateTracker.append(BleManagerState.RESETTING, PA_StateTracker.E_Intent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE);
		...
		m_taskQueue.add(new P_Task_TurnBleOn(this, /*implicit=*/false, new PA_Task.I_StateListener()
		{
			...
			public void onStateChange(PA_Task taskClass, PE_TaskState state)
			{
				if (state.isEndingState())
				{
					...
					m_nativeStateTracker.remove(BleManagerState.RESETTING, PA_StateTracker.E_Intent.UNINTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE);
					m_stateTracker.remove(BleManagerState.RESETTING, PA_StateTracker.E_Intent.UNINTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE);
    ...
    private void onDiscovered_wrapItUp(final BleDevice device, final P_NativeDeviceLayer device_native, final boolean newlyDiscovered, final byte[] scanRecord_nullable, final int rssi, final BleDeviceOrigin origin, BleManagerConfig.ScanFilter.ScanEvent scanEvent_nullable)
    {
    	if( newlyDiscovered )
    	{
	...
	final void clearScanningRelatedMembers(final PA_StateTracker.E_Intent intent)
	{
//		m_filterMngr.clear();
	...
	final boolean ready() {
		if (!m_ready)
		{
			...
			{
				m_ready = is(BleManagerState.ON);
			}
			else
			{
				m_ready = is(BleManagerState.ON) && isLocationEnabledForScanning_byRuntimePermissions() && isLocationEnabledForScanning_byOsServices();
			}
		}
		if (m_ready && !is(BleManagerState.BLE_SCAN_READY))
		{
			setBleScanReady();
		}
		return m_ready;
	...
	final void checkIdleStatus()
	{
		if (is(BleManagerState.IDLE))
		{
			...
			m_stateTracker.update(PA_StateTracker.E_Intent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE, BleManagerState.IDLE, false);
	...
	public final void update(final double timeStep_seconds, final long currentTime)
	{
		...
		if ( m_timeTurnedOn == 0 && is(BleManagerState.ON) )
		{
		...
		if( m_scanManager.update(timeStep_seconds, currentTime) == false )
		{
			...
			{
				if (!is(BleManagerState.IDLE) && m_lastTaskExecution + m_config.minTimeToIdle.millis() < currentTime)
				{
					m_updateRunnable.setUpdateRate(m_config.idleUpdateRate.millis());
					m_stateTracker.update(PA_StateTracker.E_Intent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE, BleManagerState.IDLE, true);
		...
		if (!is(BleManagerState.IDLE) && m_config.autoUpdateRate.millis() < (System.currentTimeMillis() - m_currentTick) && (m_lastUpdateLoopWarning + UPDATE_LOOP_WARNING_DELAY <= m_currentTick))
		{
	...
	{
		return is(BleManagerState.ON) && Interval.isEnabled(m_config.autoScanActiveTime) && (m_config.autoScanDuringOta || !m_deviceMngr.hasDevice(BleDeviceState.PERFORMING_OTA));
	}

	final void setBleScanReady()
	{
		m_stateTracker.update(PA_StateTracker.E_Intent.INTENTIONAL, BleStatuses.GATT_STATUS_NOT_APPLICABLE, BleManagerState.BLE_SCAN_READY, true);
	}
