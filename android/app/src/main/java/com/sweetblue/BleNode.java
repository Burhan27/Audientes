...
import com.sweetblue.annotations.Alpha;
...
import com.sweetblue.utils.EmptyCursor;
...
import com.sweetblue.utils.HistoricalDataColumn;
import com.sweetblue.utils.HistoricalDataQuery;
...
public abstract class BleNode implements UsesCustomNull
{
	...
	public static interface HistoricalDataQueryListener extends GenericListener_Void<HistoricalDataQueryListener.HistoricalDataQueryEvent>
	{
		...
		public static enum Status implements UsesCustomNull
		{
			...
			/**
			 * General failure - this feature is still in {@link Alpha} so expect more detailed error statuses in the future.
			 */
			ERROR;
