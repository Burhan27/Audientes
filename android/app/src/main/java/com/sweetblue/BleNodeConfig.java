...
public class BleNodeConfig
{
	 ...
	 * the constructor {@link HistoricalData#HistoricalData(byte[], EpochTime)}.
	 */
	@Advanced
	@Nullable(Nullable.Prevalence.NORMAL)
	...
	/**
	 * Provide an instance of this class to {@link BleDeviceConfig#historicalDataLogFilter} to control
	...
	public static interface HistoricalDataLogFilter
	{
		...
		{
			/**
			 * Satisfies soft contract of {@link UsesCustomNull}
			 */
			NULL,
			 ...
			 *
			 * @see BleDevice.ReadWriteListener.Type#READ
			 */
			READ,

			/**
			 * Originates from {@link BleDevice#startPoll(java.util.UUID, Interval, BleDevice.ReadWriteListener)}.
			 *
			 * @see BleDevice.ReadWriteListener.Type#POLL
			 */
			POLL,

			/**
			 * Originates from {@link BleDevice#enableNotify(java.util.UUID, BleDevice.ReadWriteListener)}.
			 *
			 * @see BleDevice.ReadWriteListener.Type#NOTIFICATION
			 */
			NOTIFICATION,
			 ...
			 * Originates from {@link BleDevice#enableNotify(java.util.UUID, BleDevice.ReadWriteListener)}.
			 *
			 * @see BleDevice.ReadWriteListener.Type#INDICATION
			 */
			INDICATION,

			/**
			 * Originates from {@link BleDevice#enableNotify(java.util.UUID, Interval, BleDevice.ReadWriteListener)},
			 * where a force-read timeout is invoked, or from {@link BleDevice#startChangeTrackingPoll(java.util.UUID, Interval, BleDevice.ReadWriteListener)}.
			 *
			 * @see BleDevice.ReadWriteListener.Type#PSUEDO_NOTIFICATION
			 */
			PSUEDO_NOTIFICATION,
		...
		public static class Please
		{
			...
			/**
			 * Returns the amended epoch time provided through {@link #andAmendEpochTime(EpochTime)}, or {@link EpochTime#NULL} if not applicable.
			 */
			 ...
			 * one of the {@link BleDevice#clearHistoricalData()} overloads.
			 */
	 ...
	 * of {@link HistoricalData} if you would like. For example
	 ...
	 * {@link HistoricalData} that implement this interface, so you don't
