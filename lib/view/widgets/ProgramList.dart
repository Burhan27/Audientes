              ...
              itemBuilder: (BuildContext ctxt, int index) {
                return new ExpandableNotifier(
                  ...
                  collapsed: ExpandableButton(
                      child: settingOption( programController.getColor(documents[index].data['color']),
                          programController.getIcon(documents[index].data['icon']), documents[index].data['name'], false),
                ),
                expanded: Column(
                children: <Widget>[
                                ...
                                children: <Widget>[
                                  ...
                                  SliderTheme(
                                    ...
                                    child: Slider (
                                      ...
                                      max: 5.0,
                                      divisions: 5,
                                      value: documents[index].data['high+'],
                                      onChanged: (double h) {
                                        documents[index].data['high+'] = h;
                                        setState(() {
                                          documents[index].data['high+'] = h;
                                          programController.updateProgram(documents[index].data['name'], documents[index].data['high'], documents[index].data['high+'], documents[index].data['medium'], documents[index].data['low'], documents[index].data['low+']);
                                        });
                                      },
                                    ),
                                  ),
                                  ...
                                  SliderTheme(
                                    ...
                                    child: Slider (
                                      ...
                                      max: 5.0,
                                      divisions: 5,
                                      value: documents[index].data['medium'],
                                      onChanged: (double m) {
                                        documents[index].data['medium'] = m;
                                        setState(() {
                                          documents[index].data['medium'] = m;
                                          programController.updateProgram(documents[index].data['name'], documents[index].data['high'], documents[index].data['high+'], documents[index].data['medium'], documents[index].data['low'], documents[index].data['low+']);
